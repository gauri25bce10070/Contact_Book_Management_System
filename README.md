# Contact Book Management System – Python Project

Manage your contacts easily using this simple command-line Contact Book built in Python.
It lets you add, view, search and delete contacts without any extra software or libraries.
...
Use the menu options displayed in the program and test the following actions:
...
<img width="857" height="644" alt="image" src="https://github.com/user-attachments/assets/2d0e5eb6-01d8-4299-9f11-1a99f8b7ec14" />
